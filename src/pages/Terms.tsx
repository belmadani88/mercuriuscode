...
const Terms = () => {
  return (
    <div className="min-h-screen bg-background">
      <PageSEO title="Terms of Service" description="Terms of Service for WebThangs AI workforce services. Fees, intellectual property, confidentiality, and liability." path="/terms" />
      <Navigation />
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="space-y-12">
            ...
            <div>
              ...
              <p className="text-body text-text-secondary mb-4">
                By accessing or using the services provided by WebThangs ("we," "us," or "our"), including our website, AI agents, consulting services, and related tools (collectively, the "Services"), you agree to be bound by these Terms of Service ("Terms").
              </p>

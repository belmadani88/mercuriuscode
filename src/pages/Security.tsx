...
const Security = () => {
  return (
    <div className="min-h-screen bg-background">
      <PageSEO title="Security" description="Enterprise-grade security practices at WebThangs. SOC 2 compliant, AES-256 encryption, GDPR ready." path="/security" />
      <Navigation />
            ...
            <div className="flex items-start gap-4 mb-6">
              ...
              <div>
                ...
                <p className="text-body text-text-secondary mb-4">
                  At WebThangs, we understand that deploying AI agents into your business requires absolute trust. Your data never leaves your environment unless explicitly configured. Our agents operate within your security perimeter, respecting your existing access controls and compliance requirements.
                </p>
